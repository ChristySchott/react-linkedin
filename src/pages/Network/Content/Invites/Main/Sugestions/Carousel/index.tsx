...
function Carousel() {
    return (
        ...
        >
            ...
            <Margin>
                <Slider>
                    <Slide index={0}><Item padding color="#ff4d4d" photo="https://media-exp1.licdn.com/dms/image/C4D03AQE_Sxpe-UtsFg/profile-displayphoto-shrink_200_200/0?e=1599091200&v=beta&t=-6FkuB3WMz4Ma4bHkgtDJ9uVCU-QWxOCjBzsHxEu7AU" name="Paulo Bruno Serafim" job=" Software Developer at Atlantico" number="33" /> </Slide>
                    ...
                    <Slide index={5}><Item padding color="#adad85" photo="https://media-exp1.licdn.com/dms/image/C4D03AQEs2MnAVWFb7w/profile-displayphoto-shrink_200_200/0?e=1599091200&v=beta&t=rCpbhHRvRoERPK1gzvAJm4YhvSB7GNpzMyN5NK5awyo" name="Paulo Bruno Serafim" job=" Software Developer at Atlantico" number="33" /> </Slide>
