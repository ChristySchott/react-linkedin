    ...
    <>
        {
            banner
                ? (
                    <Image>
                        <img src="https://media-exp1.licdn.com/dms/image/C4D0CAQGP78TA660W3Q/spinmail-bannerimage-shrink_300_250/0?e=1593550800&v=beta&t=-alLWqAicLXSHoHy6jyT5yCrMpMOCOyfkLS_zJgdvhY" alt="Publish" />
                    </Image>
                )
                : (
                    <Wrapper>
